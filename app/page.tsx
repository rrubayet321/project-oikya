      ...
      <div className="absolute inset-0 z-50 pointer-events-none select-none">
        ...
        >
          ...
          <a
            ...
            className="mt-1 flex items-center gap-1.5 transition-all duration-300 hover:text-[#00F0FF] hover:drop-shadow-[0_0_8px_rgba(0,240,255,0.6)]"
            style={{
              fontFamily: "'JetBrains Mono', monospace",
              fontSize: "9px",
          ...
          >
            <svg height="12" width="12" viewBox="0 0 16 16" fill="currentColor" style={{ opacity: 0.8 }}>
